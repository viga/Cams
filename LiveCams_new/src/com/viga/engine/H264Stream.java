...
public class H264Stream {				// SIZE	    HTCC510E  MIONEPLUS
	...
	/*写本地文件存储YQ头*/
	public static byte[] writeNationHead(byte[] framelen, byte[] timestamp){
		final byte[] nationhead={0,0,0,0,0,0,0,0,framelen[0],framelen[1],framelen[2],framelen[3],timestamp[0],timestamp[1],timestamp[2],timestamp[3]};
			return nationhead;
	}
