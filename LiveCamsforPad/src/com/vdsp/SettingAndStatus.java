...
public class SettingAndStatus {
	...
	public static boolean load(SQLiteDatabase db){
		...
		if(null!=cur){
			while(cur.moveToNext()){
				...
				}else if(cur.getString(0).equals("useBlueTooth")){//蓝牙
					settings.useBlueTooth=1==cur.getInt(1);
	...
	public static boolean isA10t5DM3(){
		return "A10t(5DM3)".equals(Build.MODEL);
	}
	/*VCA对象状态*/
    ...
    public class Settings{
    	...
    	public boolean useBlueTooth;//蓝牙
